...
const REFINING_CARD_TYPES = {
  xuantie: { id: "xuantie", label: "鐜勯搧", category: "material" },
  lingshi: { id: "lingshi", label: "鐏电煶", category: "material" },
  mujing: { id: "mujing", label: "鏈ㄧ簿", category: "material" },
  guanxing: { id: "guanxing", label: "瑙傛槦", category: "ability" },
  lingduan: { id: "lingduan", label: "鐏甸敾", category: "ability" },
};

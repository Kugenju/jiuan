...
const UI_TEXT = {
  ...
  infoModal: {
    ...
    daoDebateHistoryTitle: "道法论辩 · 前几轮",
  },
  flow: {
    title: "当前进展",
    nowWhatTitle: "现在要做什么",
  ...
  left: {
    ...
    daoDebatePromptLabel: "当前追问",
    daoDebatePlayerLabel: "你的回应",
    daoDebateReplyLabel: "妙哉偶回应",
    daoDebatePendingReply: "妙哉偶正在应答……",
    daoDebateNoExchangeHint: "请先择一论点回应。",
    daoDebateHistoryBtn: "查看前几轮",
    daoDebateHistoryEmpty: "当前还没有可回看的前几轮对话。",
    summaryTitle: "本周结果",
    summaryPending: "待结算",
    resourcesTitle: "资源",
    bootTitle: "开始前",
